...
class Ui_TSKF301MainWindow(object):
    def setupUi(self, TSKF301MainWindow):
        ...
        self.speed_v_lyt = QtWidgets.QVBoxLayout() #######
        self.speed_v_lyt.setObjectName("speed_v_lyt")
        self.speed_label = QtWidgets.QLabel(self.current_ship_frame)
        self.speed_label.setObjectName("speed_label")
        self.speed_label.setText("SPEED")
        self.speed_v_lyt.addWidget(self.speed_label)
        self.auto_speed_h_lyt = QtWidgets.QHBoxLayout()
        self.auto_speed_h_lyt.setObjectName("auto_speed_h_lyt")
        self.auto_speed_r_but = QtWidgets.QRadioButton(self.current_ship_frame)
        self.auto_speed_r_but.setObjectName("auto_speed_r_but")
        self.auto_speed_r_but.setText("AUTO")
        self.auto_speed_h_lyt.addWidget(self.auto_speed_r_but)
        self.speed_options_vlyt = QtWidgets.QVBoxLayout()
        self.speed_options_vlyt.setObjectName("speed_options_vlyt")
        self.ahead_full_r_but = QtWidgets.QRadioButton(self.current_ship_frame)
        self.ahead_full_r_but.setObjectName("ahead_full_r_but")
        self.ahead_full_r_but.setText("AHEAD FULL")
        self.speed_options_vlyt.addWidget(self.ahead_full_r_but)
        self.fast_r_but = QtWidgets.QRadioButton(self.current_ship_frame)
        self.fast_r_but.setObjectName("fast_r_but")
        self.fast_r_but.setText("FAST")
        self.speed_options_vlyt.addWidget(self.fast_r_but)
        self.slow_r_but = QtWidgets.QRadioButton(self.current_ship_frame)
        self.slow_r_but.setObjectName("slow_r_but")
        self.slow_r_but.setText("SLOW")
        self.speed_options_vlyt.addWidget(self.slow_r_but)
        self.stop_r_but = QtWidgets.QRadioButton(self.current_ship_frame)
        self.stop_r_but.setObjectName("stop_r_but")
        self.stop_r_but.setText("STOP")
        self.speed_options_vlyt.addWidget(self.stop_r_but)
        self.auto_speed_h_lyt.addLayout(self.speed_options_vlyt)
        self.speed_v_lyt.addLayout(self.auto_speed_h_lyt)
        self.displays_h_lyt.addLayout(self.speed_v_lyt) #######
